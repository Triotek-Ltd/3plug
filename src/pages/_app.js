...
const PUBLIC_ROUTES = new Set([
  ...
  "/workbench/workspace-builder",
  "/workbench/navigation-builder",
  "/workbench/workflow-builder",
  "/workbench/automation-builder",
  "/workbench/notification-builder",
  "/workbench/integration-builder",
  "/workbench/import-export-builder",
  "/workbench/query-builder",
  "/workbench/theme-builder",
  "/workbench/localization-builder",
